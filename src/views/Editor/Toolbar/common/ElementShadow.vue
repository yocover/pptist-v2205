    ...
    <template v-if="hasShadow && shadow">
      <div class="row">
        ...
        <Slider 
          ...
          :step="1" 
          :value="shadow.h" 
          @change="value => updateShadow({ h: Array.isArray(value) ? value[0] : value })"
        />
      </div>
      <div class="row">
        ...
        <Slider
          ...
          :step="1"
          :value="shadow.v"
          @change="value => updateShadow({ v: Array.isArray(value) ? value[0] : value })"
        />
      </div>
      <div class="row">
        ...
        <Slider
          ...
          :step="1"
          :value="shadow.blur"
          @change="value => updateShadow({ blur: Array.isArray(value) ? value[0] : value })"
        />
      </div>
      <div class="row">
