  ...
  <div class="slide-design-panel">
    ...
    <div class="row">
      <Select 
        ...
        @change="value => updateBackgroundType(value as 'solid' | 'image' | 'gradient')"
      >
      ...
      <Select 
        ...
        @change="value => updateBackground({ imageSize: value as 'contain' | 'repeat' | 'cover' })"
    ...
    <div class="background-gradient-wrapper" v-if="background.type === 'gradient'">
      <div class="row">
        ...
        <Popover trigger="click">
          <template #content>
            <ColorPicker
              :modelValue="background.gradientColor?.[0] || '#fff'"
              @update:modelValue="value => updateBackground({ gradientColor: [value, background.gradientColor?.[1] || '#fff'] })"
            />
          </template>
      ...
      <div class="row">
        ...
        <Popover trigger="click">
          <template #content>
            <ColorPicker
              :modelValue="background.gradientColor?.[1] || '#fff'"
              @update:modelValue="value => updateBackground({ gradientColor: [background.gradientColor?.[0] || '#fff', value] })"
            />
          </template>
      ...
      <div class="row" v-if="background.gradientType === 'linear'">
        ...
        <Slider
          ...
          @change="value => updateBackground({ gradientRotate: Array.isArray(value) ? value[0] : value })" 
        />
      </div>
    </div>
